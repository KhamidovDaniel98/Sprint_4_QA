...
public class OrderPageSamokat {
    ...
    //Поле имя
    private final By nameField = By.xpath(".//*[@id='root']//input[@placeholder='* Имя']");

    //Поле фамилия
    private final By lastNameField = By.xpath(".//*[@id='root']//input[@placeholder='* Фамилия']");

    //Поле адрес
    private final By addressField = By.xpath(".//*[@id='root']//input[@placeholder='* Адрес: куда привезти заказ']");

    //Поле станция метро
    private final By metroStationField = By.xpath(".//*[@id='root']//input[@placeholder='* Станция метро']");

    //Поле телефон
    private final By phoneField = By.xpath(".//*[@id='root']//input[@placeholder='* Телефон: на него позвонит курьер']");

    //Кнопка далее
    private final By nextButton = By.xpath(".//*[@id='root']//button[text()='Далее']");

    //Поле даты
    private final By dateField = By.xpath(".//*[@id='root']//input[@placeholder ='* Когда привезти самокат']");
    ...
    private final By colorBlackCheckbox = By.xpath(".//*[@id='root']//label[@for = 'black']");

    //Чекбокс серого цвета
    private final By colorGreyCheckbox = By.xpath(".//*[@id='root']//label[@for = 'grey']");

    //Поле комментария
    private final By commentField = By.xpath(".//*[@id='root']//input[@placeholder='Комментарий для курьера']");
    ...
    private final By orderModalView = By.className("Order_Modal__YZ-d3");

    //Заказ оформлен
    private final  By headerOrderModalView = By.className("Order_ModalHeader__3FDaJ");

    //Кнопка кук
    private final By cookiesApprove = By.id("rcc-confirm-button");
    ...
    public void waitForLoadOrderModalView() {
        new WebDriverWait(driver, Duration.ofSeconds(10)).until(driver -> (driver.findElement(orderModalView)));
    }
